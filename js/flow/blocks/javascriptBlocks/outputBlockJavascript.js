class OutputBlockJavascript extends OutputBlock {
      ...
      help:
        ...
        <p>
          <ul style="margin-left: 25px;">
            <li>Print line - (alert): > PRINTLN()</li>
            <li>Print - (alert): > PRINT()</li>
          </ul>
        </p>    
     <p>List of variables: lists of defined varialbles</p>
      ...
      content:
        ...
        <div style="font-size:1.4em; margin-top:10px;">Variables</div>
         ...
         <input type="text" id="expression" name="expression" value='${this.expression}' required placeholder='Ex: "Your name is: "+myVarName+"!"'  style="width: 95%; padding:8px;" required >
