class CogwheelBlock {
  ...
  render() {
    ...
    this.c.ctx.moveTo(this.x + this.radiusO * Math.cos(this.taperAO), this.y + this.radiusO * Math.sin(this.taperAO));
    for (; this.a <= this.pi2; this.a += this.angle) {
      if (this.toggle) {
        this.c.ctx.lineTo(this.x + this.radiusI * Math.cos(this.a - this.taperAI),
          this.y + this.radiusI * Math.sin(this.a - this.taperAI));
        this.c.ctx.lineTo(this.x + this.radiusO * Math.cos(this.a + this.taperAO),
